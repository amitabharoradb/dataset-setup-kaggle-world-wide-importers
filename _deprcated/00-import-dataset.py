...
# MAGIC %md
# MAGIC # NOTE: This code does the same thing as the production ready code but downloads data all the way from Kaggle web site directly.
# MAGIC Instead we now download the data zip file manually, hold it in this git repo and create tables from it.  Therefore the user does not need to have Kaggle login to create the data
